                ...
                <div class="nk-sidebar-element nk-sidebar-head">
                    ...
                    <div class="nk-sidebar-brand">
                        <a href="html/index.html" class="logo-link nk-sidebar-logo">
                            ...
                            <img class="logo-dark logo-img" src="{{asset('theme/backend/images/logo-dark.png')}}" srcset="{{asset('theme/backend/images/logo-dark2x.png 2x')}}" alt="logo-dark">
                        </a>
                    </div>
                        ...
                        <div class="nk-sidebar-menu" data-simplebar>
                            <ul class="nk-menu">
                                ...
                                <li class="nk-menu-heading">
                                    <h6 class="overline-title text-primary-alt">Section One</h6>
                                </li><!-- .nk-menu-heading -->
